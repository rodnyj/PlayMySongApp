...
<form id="create_event_form" method="POST" enctype="multipart/form-data" action="eventviewer.php?choice=1" >
    <table class=createevent>
        ...
        <tr><td class=createevent>Event Location:</td> <td><input class="c_e_class" id="create_event_locatio_id" type="text" name="event_location"/></td></tr>
        <tr><td class=createevent>Start Date & Time:</td> <td><input class="c_e_class" id="startdate_id" type="date" name="start_time" value="YYYY-MM-DD HH:MM:SS"></td></tr>
        <tr><td class=createevent>End Date & Time:</td> <td><input class="c_e_class" id="enddate_id" type="date" name="end_time" value="YYYY-MM-DD HH:MM:SS"></td></tr>
        <tr><td class=createevent>Song Request Limit:</td> <td><input class="c_e_class" type="text" name="song_request_Limit"></td></tr>
        <tr><td class=createevent>Event Description:</td> <td><textarea class="c_e_class" name="event_description" id="description_id" cols=25 rows=3></textarea></td></tr>
